...
zip_files <- c("data/passing.zip", "data/invasion.zip", "data/events.zip", "data/acceleration.zip")

# Unzip each directory
...
match_event_plot <- function(match_id, matches, players, teams) {
  # Get info for match
...
ui <- fluidPage(
  ...
  # Event pitch plot
  fluidRow(
    column(12, plotlyOutput("pitchPlot", height = "500px"))
  ),
  # Passing network
  fluidRow(
...
server <- function(input, output, session) {
  ...
  output$pitchPlot <- renderPlotly({
    ...
    match_event_plot(selected_match_id(), matches, players, teams)
  })
